      ...
      <div className="w-[90%] mx-auto flex flex-col lg:flex-row gap-4 items-center justify-between">
        ...
        <div className="bg-[#1c1c1c] text-white flex-1 rounded-xl w-full flex flex-col lg:flex-row divide-y lg:divide-y-0 lg:divide-x divide-[#444]">
          ...
          <div className="flex-1 text-center p-10">
            <h3 className="animate-obj text-xl font-semibold text-[#E5C7A2] mb-2">Many Collection</h3>
          ...
          <div className="flex-1 text-center p-6">
            <h3 className="animate-obj text-xl font-semibold text-[#E5C7A2] mb-2">Photo Free</h3>
            <p className="animate-obj text-sm text-gray-300">
          ...
          {/* Box 3 */}
          <div className="flex-1 text-center p-6">
            <h3 className="animate-obj text-xl font-semibold text-[#E5C7A2] mb-2">Free Guide</h3>
            <p className="animate-obj text-sm text-gray-300">
        ...
        {/* Visitors Card */}
        <div className="animate-obj bg-[#E8DECE] rounded-xl px-6 py-6 text-center w-full lg:w-auto">
