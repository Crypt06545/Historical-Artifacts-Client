...
const feedbacks = [
  {
    ...
    message: "The digital preservation of these artifacts is remarkable. As a historian, I appreciate the attention to detail and accuracy in the descriptions provided.",
  ...
  {
    name: "David Chen",
    message: "This platform has been invaluable for my research. The high-resolution images allow me to examine artifacts closely without needing physical access.",
  ...
  },
  {
    ...
    message: "An excellent resource for educators. My students love exploring the collection, and the metadata is perfect for classroom discussions about ancient civilizations.",
  ...
  {
    name: "Mohamed Hassan",
    message: "The search functionality works flawlessly. I can quickly find artifacts by period, material, or location - exactly what museum professionals need.",
...
const Feedback = () => {
  return (
    <div className="bg-[#302E2F] dark:bg-[#1F1D1D] py-16 px-4 sm:px-6 lg:px-8">
      <Helmet>
        <title>EGYPT - Professional Reviews</title>
      </Helmet>
