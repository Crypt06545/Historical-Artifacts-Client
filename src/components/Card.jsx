        ...
        <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md bg-[#4A4746] text-[#E0D9D1]">
          ...
          <div>
            ...
            <p className="text-sm text-[#cfbaa2]">
              Eu qualisque aliquando mel, id lorem detraxit nec, ad elit minimum pri. Illum ipsum detracto ne cum. Mundi nemore te ius, vim ad illud atqui apeirian...
            </p>
          </div>
            ...
            <div className="flex space-x-2 text-sm dark:text-gray-600">
              <button type="button" className="flex items-center p-1 space-x-1.5">
                <svg
                  ...
                  className="w-4 h-4 fill-current text-[#A9927D]"
                >
                ...
                <span className="text-[#A9927D]">283</span>
              </button>
            </div>
              <button className="px-3 p-2 border rounded-md bg-[#393738] hover:bg-[#D99578]">
